    ...
    <div className="bg-gray-100 py-20 px-4">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        ...
        <div className="relative p-8 rounded-2xl text-white bg-gradient-to-r from-purple-600 to-indigo-600 shadow-lg">
          ...
          {/* Badge */}
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-yellow-400 text-xs px-4 py-1 rounded-full font-medium text-gray-800 hover:shadow-xl">
            Most Popular
          </div>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl">
          ...
          <button className="mt-8 w-full py-3 rounded-full bg-linear-to-r from-purple-500 to-purple-700 text-white font-medium">
            Contact Sales
          </button>
        </div>
